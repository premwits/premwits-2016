...
<body>
    <div>
		...
		<tr style="height:100%">
			...
			<?
			if(!isset($_COOKIE['next_time0']))
			{
				session_start();
				setcookie("next_time0",1451266954, time() + (86400 * 30), "/"); //1451265000
				setcookie("next_time1",1451266954, time() + (86400 * 30), "/"); //1451265000
				setcookie("next_time2",1451267254, time() + (86400 * 30), "/"); //1451265300
			?>
